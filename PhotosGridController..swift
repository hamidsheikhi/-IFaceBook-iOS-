...
class PhotoGridCell: LBTAListCell<String> {
    ...
    let imageView = UIImageView(image:
        UIImage(named: "Steve1"), contentMode:
        .scaleAspectFill)
...
class PhotosGridController: LBTAListController<PhotoGridCell, String>, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        self.items = ["Steve1", "Steve2", "Steve3", "Steve4", "Steve1"]
    }
...
struct PhotosGridPreview: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context:
            UIViewControllerRepresentableContext<PhotosGridPreview.ContainerView>) ->
            UIViewController {
                return PhotosGridController()
     }
        
        func updateUIViewController(_ uiViewController: PhotosGridPreview.ContainerView.UIViewControllerType,
            context:
            UIViewControllerRepresentableContext<PhotosGridPreview.ContainerView>) {
