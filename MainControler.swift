...
//  IFaceBook
//
//  Created by hamid sheikhi on 2020. 07. 16..
...
class PostCell: LBTAListCell<String> {
    ...
    let imageView = UIImageView(backgroundColor: .black)
    let nameLabel = UILabel(text: "Steve Job")
    let dateLabel = UILabel(text: "Friday at 11:11 AM")
    let postTextLabel = UILabel(text: "I'm as proud of what we don't do as I am of what we do.")
//  let imageViewGrid = UIView(backgroundColor: .orange)
    ...
    let photosGridController = PhotosGridController()
     ...
     override func setupViews() {
        ...
        stack(hstack(imageView.withHeight(40).withWidth(40), stack(nameLabel, dateLabel),
                     spacing: 8
...
class StoryHeader: UICollectionReusableView {
    ...
    let storiesController = StoriesController(scrollDirection:
        .horizontal)
...
class StoryPhotoCell: LBTAListCell<String> {
    ...
    let nameLabel = UILabel(text: "Steve Jobs", font: .boldSystemFont(ofSize: 14), textColor: .white)
...
class StoriesController: LBTAListController<StoryPhotoCell, String>, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.items = ["Steve2", "Steve4","Steve1", "Steve3","Steve5"]
    }
...
class MainController: LBTAListHeaderController<PostCell, String, StoryHeader> , UICollectionViewDelegateFlowLayout{
    ...
    func collectionView( _ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
     ...
     override func viewDidLoad() {
        ...
        self.items = ["hello", "Hamid", "1", "2"]
        setupNavBar()
    }
    let fbLogoImageView = UIImageView(image: UIImage(named: "fb_logo"),
                                      contentMode: .scaleAspectFit);         let searchButton = UIButton(title: "Search", titleColor: .black)
